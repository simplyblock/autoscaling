...
func (in *BlockDeviceSource) DeepCopyInto(out *BlockDeviceSource) {
	*out = *in
	if in.PersistentVolumeClaim != nil {
		in, out := &in.PersistentVolumeClaim, &out.PersistentVolumeClaim
		*out = new(BlockPersistentVolumeClaim)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BlockDeviceSource.
func (in *BlockDeviceSource) DeepCopy() *BlockDeviceSource {
	if in == nil {
		return nil
	}
	out := new(BlockDeviceSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BlockDeviceStatus) DeepCopyInto(out *BlockDeviceStatus) {
	*out = *in
	if in.RequestedStorage != nil {
		in, out := &in.RequestedStorage, &out.RequestedStorage
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.CurrentStorage != nil {
		in, out := &in.CurrentStorage, &out.CurrentStorage
		x := (*in).DeepCopy()
		*out = &x
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BlockPersistentVolumeClaim) DeepCopyInto(out *BlockPersistentVolumeClaim) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BlockPersistentVolumeClaim.
func (in *BlockPersistentVolumeClaim) DeepCopy() *BlockPersistentVolumeClaim {
	if in == nil {
		return nil
	}
	out := new(BlockPersistentVolumeClaim)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OvercommitSettings) DeepCopyInto(out *OvercommitSettings) {
	*out = *in
	if in.CPU != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OvercommitSettings.
func (in *OvercommitSettings) DeepCopy() *OvercommitSettings {
	if in == nil {
		return nil
	}
	out := new(OvercommitSettings)
	in.DeepCopyInto(out)
	return out
}
