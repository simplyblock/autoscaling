...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BlockDeviceMount) DeepCopyInto(out *BlockDeviceMount) {
	*out = *in
	if in.FormatIfNeeded != nil {
		in, out := &in.FormatIfNeeded, &out.FormatIfNeeded
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BlockDeviceMount.
func (in *BlockDeviceMount) DeepCopy() *BlockDeviceMount {
	if in == nil {
		return nil
	}
	out := new(BlockDeviceMount)
